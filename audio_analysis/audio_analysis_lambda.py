...
def main(event, context):
    ...
    saved_bool = event['saved_bool']
    playlist_bool = event['playlist_bool']
    ...
    if len(setting_tracks_objects_list) > 0:
        if setting == "morning":
        ...
        create_status = str(setting_tracks_list_length) + " songs added to playlist: [" + playlist_name + "]"
        ...
        create_status = "There were no tracks in your playlists/liked tracks that matched the setting: " + setting 
