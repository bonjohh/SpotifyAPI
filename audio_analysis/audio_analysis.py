...
def main(user_id, saved_bool, playlist_bool, setting):
    ...
    if total_tracks_list_length > 0:
        split_range = int(total_tracks_list_length / 50) + 1
        for i in range(0, split_range):
            split = split_set(total_tracks_list, i, 50)
...
# consider making tracks an object with attributes